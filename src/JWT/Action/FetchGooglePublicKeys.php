...
{
    private const DEFAULT_URL = 'https://www.googleapis.com/robot/v1/metadata/x509/securetoken@system.gserviceaccount.com';
    private const DEFAULT_FALLBACK_CACHE_DURATION = 'PT1H';
